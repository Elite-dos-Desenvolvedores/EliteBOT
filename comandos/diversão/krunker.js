...
exports.run = async (client, message, args) => {
    ...
    Krunker.getUser(nome).then(data => {
        ...
        const url = 'https://media.discordapp.net/attachments/594236186311000068/627966424081760256/Krunker_Banner.png';
        ...
        if (level === 'Dados do usuário não foram encontrados') level = 'Indefinido';
